...
<div class='mergado-tab' data-tab='4'>
    <div id="mergadoCron">
        <div class="panel " id="mergado_fieldset_mergado_lang">
            ...
            {l s='Do not hesitate to contact us on'} <a href='mailto:prestashop@mergado.cz'>prestashop@mergado.cz</a> {l s='in case of any question.'}
        </div>
    </div>
</div>
<div class='mergado-tab' data-tab='5'>
    <div id="mergadoCron">
        <div class="panel " id="mergado_fieldset_mergado_lang">
            ...
            <p>{l s='Using the module Mergado marketing pack within PrestaShop is free. Supported versions of PrestaShop are starting 1.6.0.0 above.' mod='mergado'}</p>
        </div>
    </div>
</div>
