...
<div id="mergadoHeader">
    ...
    <div class="tabControl">
        ...
        <a href="#" data-tab="7">{l s='News' mod='mergado'}</a>
...
{if $unreadedTopNews}
    {foreach $unreadedTopNews as $item}
        <div class="alert alert-warning">
            <strong>
                <a href="#" class="text-warning mergado" data-tab-link="7">
                    {$item['title']}
                </a>
            </strong>
        </div>
...
{if $unreadedNews}
    <div class="alert alert-info">
        <strong class="pl-10">{l s='We have some news for you' mod='mergado'} :</strong>
        <a href="#" data-tab-link="7">
            <ul>
                {foreach $unreadedNews as $topic}
                    <li>{$topic['title']}</li>
                {/foreach}
            </ul>
        </a>
